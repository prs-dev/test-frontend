  ...
  return (
    <div>
      <div className='relative'>
        ...
        <h2 className='absolute bottom-0 text-3xl bg-mainColor flex items-center justify-center text-white p-1 m-10 md:w-[20%] lg:w-[20%]'>Vastu Consultancy</h2>
      </div>
      <div className='w-[70%] mx-auto'>
        <div className='flex flex-col gap-2 items-center justify-center my-10'>
          <h2 className='text-3xl bg-mainColor flex items-center justify-center text-white p-1 md:w-[40%] lg:w-[40%]'>Best Vastu Consultancy in India</h2>
        ...
        <div className='bg-mainColor flex flex-col md:flex-row lg:flex-row'>
        ...
        <div className='flex flex-col gap-2 items-center justify-center my-10'>
          <h2 className='text-3xl bg-mainColor flex items-center justify-center text-white p-1 md:w-[40%] lg:w-[40%]'>Comprehensive Vastu Solutions:</h2>
        ...
        <div className='bg-mainColor flex-col md:flex-row lg:flex-row flex my-10'>
          <div className='flex-[2] text-white p-10 flex flex-col gap-2 items-center justify-center'>
        ...
        <div className='flex flex-col md:flex-row lg:flex-row gap-5 my-10'>
          <motion.div  whileHover={{scale: 1.1}} className='overflow-hidden lg:overflow-clip flex-1 max-h-[40vh] lg:max-h-[50vh] shadow-lg p-2 rounded-sm'>
            <img className="w-full object-cover h-[10vh] md:h-[50%] lg:h-[50%]" src="/assets/resi-vastu.jpg" alt="" />
          ...
          <motion.div whileHover={{scale: 1.1}} className='overflow-hidden lg:overflow-clip flex-1 max-h-[50vh] shadow-lg p-2 rounded-sm'>
            <img className="w-full object-cover h-[10vh] md:h-[50%] lg:h-[50%]" src="/assets/Commercial-Vastu.jpg" alt="" />
          ...
          <motion.div whileHover={{scale: 1.1}} className='overflow-hidden lg:overflow-clip flex-1 max-h-[50vh] shadow-lg p-2 rounded-sm'>
            <img className="w-full object-cover h-[10vh] md:h-[50%] lg:h-[50%]" src="/assets/Industrial-Vastu.jpg" alt="" />
